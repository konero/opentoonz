...
#if defined(_WIN32)
  // Keep Qt's high-frequency compression for non-drawing UI events. Do not
  // enable Qt's tablet compression: Brush tools choose whether to receive
  // every tablet sample in SceneViewer::tabletEvent().
