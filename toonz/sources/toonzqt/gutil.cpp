...
//    if (!onPixmap.isNull()) {
//      icon.addPixmap(
//          compositePixmap(onPixmap, onOpacity, canvasW, canvasH, iconW,
//          iconH), QIcon::Normal, QIcon::On);
//      icon.addPixmap(compositePixmap(onPixmap, normalOpacity, canvasW,
//      canvasH,
//                                     iconW, iconH),
...
//     * 20x20 pixmap so that it is compatible with toolbars, otherwise it will
//     be
//     * scaled up and blur. You need to add icons to all QIcon modes otherwise
//     it
//     * will use the original size, which is undesirable. This is equal to
//     having
